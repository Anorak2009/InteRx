...
def run_streamlit(df: pd.DataFrame, ror_df: pd.DataFrame, novel_df: pd.DataFrame,
    ...
    st.markdown("""
    <style>
        /* Accent #00e9ab — dark text on teal keeps contrast ratio > 4.5:1 in both modes */
        .stButton > button {
            background-color: #00e9ab !important;
        ...
        button[data-baseweb="tab"][aria-selected="true"] {
            border-bottom-color: #00e9ab !important;
            color: #00e9ab !important;
        }
        div[data-testid="stSlider"] > div > div > div > div {
            background: #00e9ab !important;
        }
        ...
        div[data-testid="stAlert"] {
            border-left-color: #00e9ab !important;
        }
        /* Light mode */
        ...
        @media (prefers-color-scheme: dark) {
            .stMarkdown p, .stMarkdown li { color: #e8e8e8 !important; }
            div[data-testid="stCaptionContainer"] { color: #aaaaaa !important; }
            .dvn-scroller .col_heading { color: #00e9ab !important; }
        }
    </style>
    ...
    with tab3:
        if graph_data is None:
            ...
            fig2.add_trace(go.Scatter(
                ...
                line=dict(width=0.8, color="rgba(128,128,128,0.4)"), hoverinfo="none",
            ))
            fig2.add_trace(go.Scatter(
                x=pos[:, 0], y=pos[:, 1], mode="markers+text",
                marker=dict(size=8, color="#00e9ab", line=dict(width=1, color="#0a0a0a")),
